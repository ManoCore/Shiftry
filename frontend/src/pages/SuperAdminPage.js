...
// import { fetchAllUsers, deleteUser } from "../api"; // Assuming these APIs can also manage admins
// import AddUserModal from "./AddUserModal"; // Reusing the AddUserModal for adding admins
// import { useAuth } from '../context/AuthContext';
// import 'jspdf-autotable'; // For PDF export (though less common for admin lists)
...
//     // Function to fetch ONLY admin users from the backend
//     const fetchAdmins = async () => {
//         try {
//             setLoading(true);
//             const res = await fetchAllUsers(); // Assuming fetchAllUsers returns all users
//             // Filter to get only users with 'admin' role
//             const filteredAdmins = res.data.data.filter(user => user.access === 'admin');
...
//                 isActive: admin.isActive // Assuming your admin user object has an 'isActive' or similar flag
//             }));
...
//     useEffect(() => {
//         // Only fetch admins if the current logged-in user is a super admin
//         if (currentUser && currentUser.role === 'admin') {
//             fetchAdmins();
//         } else if (!isAuthLoading) {
//             // If not super admin and auth is not loading, redirect or show unauthorized message
...
//         try {
//             await deleteUser(selectedAdminId); // Reusing deleteUser, assuming it works for any user ID
...
//     // You'd need a backend API endpoint for this (e.g., PUT /api/users/{id}/toggle-access)
//     const toggleAdminAccess = async (adminId, currentStatus) => {
//         setLoading(true);
//         setError(null);
//         try {
//             // Placeholder for your API call to update admin access
//             // Example: await updateAdminAccess(adminId, !currentStatus);
//             console.log(`Toggling access for admin ${adminId} to ${!currentStatus}`);
...
//                 )
//             );
//             setSuccessMessage(`Admin access ${!currentStatus ? 'granted' : 'revoked'} successfully.`);
//         } catch (err) {
//             setError("Failed to toggle admin access. Please try again.");
...
//     // Render unauthorized message if not a super admin
//     if (currentUser && currentUser.role !== 'admin') {
//         return (
//             <div className="flex justify-center items-center min-h-screen bg-gray-100">
